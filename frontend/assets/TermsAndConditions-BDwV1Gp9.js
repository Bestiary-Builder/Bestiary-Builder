import{M as s}from"./index-BMSQkwth.js";import{d as r,_ as a,r as i,o as n,c as t,a as l,b as c,i as d,F as u}from"./index-BB4lYkn2.js";const m=`## General scope
...
`,p=s(),h=r({data(){return{content:p.render(m)}}}),f={class:"content markdown less-wide"},g=["innerHTML"];function b(e,y,w,_,v,B){const o=i("Breadcrumbs");return n(),t(u,null,[l(o,{routes:[{path:"",text:"Terms and Conditions",isCurrent:!0}],isLessWide:!0}),c("div",f,[e.content?(n(),t("div",{key:0,innerHTML:e.content},null,8,g)):d("",!0)])],64)}const k=a(h,[["render",b]]);export{k as default};
