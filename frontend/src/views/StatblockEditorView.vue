            ...
            <div class="editor-content__tab-inner scale-in">
                ...
                <div class="editor-field__container three-wide">
                    <div class="flow-vertically">
                        ...
                        <div class="quantity">
                            <input 
                                type="number" 
                                v-model="data.abilities.stats.str" 
                                min="1" 
                                step="30"
                                inputmode="numeric"
                                id="strstat"
                    ...
                    <div class="flow-vertically">
                        ...
                        <div class="quantity">
                            <input 
                                type="number" 
                                v-model="data.abilities.stats.dex" 
                                min="1" 
                                step="30"
                                inputmode="numeric"
                                id="dexstat"
                    ...
                    <div class="flow-vertically">
                        ...
                        <div class="quantity">
                            <input 
                                type="number" 
                                v-model="data.abilities.stats.con" 
                                min="1" 
                                step="30"
                                inputmode="numeric"
                                id="constat"
                ...
                <div class="editor-field__container three-wide">
                    <div class="flow-vertically">
                        ...
                        <div class="quantity">
                            <input 
                                type="number" 
                                v-model="data.abilities.stats.int" 
                                min="1" 
                                step="30"
                                inputmode="numeric"
                                id="intstat"
                    ...
                    <div class="flow-vertically">
                        ...
                        <div class="quantity">
                            <input 
                                type="number" 
                                v-model="data.abilities.stats.wis" 
                                min="1" 
                                step="30"
                                inputmode="numeric"
                                id="wisstat"
                    ...
                    <div class="flow-vertically">
                        ...
                        <div class="quantity">
                            <input 
                                type="number" 
                                v-model="data.abilities.stats.cha" 
                                min="1" 
                                step="30"
                                inputmode="numeric"
                                id="chastat"
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div class="quantity">
                                    <input 
                                        type="number" 
                                        v-model="data.abilities.saves.str.override" 
                                        inputmode="numeric"
                                        id="strsave"
                                    >
                                    <div class="quantity-nav">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div class="quantity">
                                    <input 
                                        type="number" 
                                        v-model="data.abilities.saves.dex.override" 
                                        inputmode="numeric"
                                        id="dexsave"
                                    >
                                    <div class="quantity-nav">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <div class="quantity">
                                    <input 
                                        type="number" 
                                        v-model="data.abilities.saves.con.override" 
                                        inputmode="numeric"
                                        id="consave"
                                    >
                                    <div class="quantity-nav">
                ...
                <div class="editor-field__container three-wide" >
                    <div v-for="skill, index in data.abilities.skills" class="flow-vertically">
                        ...
                        <p> <label :for="skill.skillName + 'halfprof'"> half prof </label> <input type="checkbox" v-model="skill.isHalfProficient" @click="disableOtherSkills(index, 'halfprof', skill.isHalfProficient)"
                            :id="skill.skillName + 'halfprof'"> </p>
                        </div>
                        <div>
                            ...
                            <div class="quantity">
                                <input 
                                    type="number" 
                                    v-model="skill.override" 
                                    step="1"
                                    inputmode="numeric"
                                    :id="skill.skillName + 'override'"
                                >
                                <div class="quantity-nav">
                ...
                <div class="editor-field__container three-wide">
                    <div class="flow-vertically">
                        ...
                        <div class="quantity">
                            <input 
                                type="number" 
                                v-model="data.defenses.hp.sizeOfHitDie" 
                                min="0" 
                                step="2"
                                inputmode="numeric"
                                id="hitdiesize"
                    ...
                    <div class="flow-vertically">
                        ...
                        <div class="quantity">
                            <input 
                                type="number" 
                                v-model="data.defenses.hp.numOfHitDie" 
                                min="1" 
                                inputmode="numeric"
                                id="hitdienum"
                            >
                    ...
                    <div class="flow-vertically">
                        ...
                        <div class="quantity">
                            <input 
                                type="number" 
                                v-model="data.defenses.hp.override" 
                                min="1" 
                                step="1"
                                inputmode="numeric"
                                id="hpoverride"
