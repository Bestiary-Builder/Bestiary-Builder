			...
			<div class="navbar-right" :class="{ settings: store.user !== null }">
				<RouterLink v-if="store.user" class="user" to="/user" @click="isExpanded = false">
					...
					<div class="image-wrapper">
						<img alt="avatar" :src="store.user.avatar ? `https://cdn.discordapp.com/avatars/${store.user.id}/${store.user.avatar}.png` : 'https://cdn.discordapp.com/embed/avatars/0.png'">
