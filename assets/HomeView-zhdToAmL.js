import{M as n}from"./index-5Jdbla-E.js";import{B as i}from"./Breadcrumbs-ruvbO6jY.js";import{d as r,_ as o,o as t,c as a,b as s,i as c,F as d,M as l}from"./index-0Kkg6nBX.js";const p=`<!-- <img src="/logo-text.svg" width="75%" style="margin: auto">
...
`,g=n({html:!0,linkify:!0,typographer:!0}),v=r({data(){return{content:g.render(p)}},components:{Breadcrumbs:i}}),h="/mmcover.jpg",m=l('<div class="article-header" data-v-fc1ecef5><div class="header-content" data-v-fc1ecef5><h1 class="header-title" data-v-fc1ecef5> Bestiary Builder </h1><p data-v-fc1ecef5>Welcome to Bestiary Builder, <i data-v-fc1ecef5>the</i> convenient Bestiary Creator for D&amp;D 5e, designed for incredible integration with <a href="https://avrae.io/" data-v-fc1ecef5> Avrae</a> and convenience of use!</p></div><img src="'+h+'" alt="" class="header-image" data-v-fc1ecef5></div>',1),u={class:"content markdown less-wide"},y=["innerHTML"];function f(e,w,b,B,_,k){return t(),a(d,null,[m,s("div",u,[e.content?(t(),a("div",{key:0,innerHTML:e.content},null,8,y)):c("",!0)])],64)}const x=o(v,[["render",f],["__scopeId","data-v-fc1ecef5"]]);export{x as default};
