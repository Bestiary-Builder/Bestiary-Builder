import{M as n}from"./index-5Jdbla-E.js";import{B as r}from"./Breadcrumbs-X-Vry4Gc.js";import{d as i,_ as s,r as c,o as e,c as o,a as d,b as p,i as l,F as h}from"./index-zUiipp0z.js";const u=`
<img src="/logo-text.svg" width="75%" style="margin: auto">

---

**Welcome to Bestiary Builder, *the* convenient Bestiary Creator for D&D 5e, designed for incredible integration with [Avrae](https://avrae.io/) and convenience of use!**
...
</div>`,m=n({html:!0,linkify:!0,typographer:!0}),y=i({data(){return{content:m.render(u)}},components:{Breadcrumbs:r}}),g={class:"content markdown less-wide"},b=["innerHTML"];function f(t,v,w,B,C,k){const a=c("Breadcrumbs");return e(),o(h,null,[d(a,{routes:[{path:"",text:"Home",isCurrent:!0}],isLessWide:!0}),p("div",g,[t.content?(e(),o("div",{key:0,innerHTML:t.content},null,8,b)):l("",!0)])],64)}const D=s(y,[["render",f]]);export{D as default};
